...
namespace Task_App
{
    ...
    public sealed partial class TaskDetailedView : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            click = data.click1;
            tds = data.tds;
           // _itemnotify = new itemnotify { taskName = click.name, statu=click.status,collective=click.collective,prior=click.priority, taskDetails=click.details};
